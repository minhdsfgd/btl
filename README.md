...
#### **Test Case 1: Xác thực (Authentication)**
```
1. Đăng nhập với tài khoản Admin
   - Username: admin
   - Password: admin123
   ✓ Kỳ vọng: Vào dashboard Admin

2. Đăng nhập với tài khoản Regular User
   - Username: user1
   - Password: user123
   ✓ Kỳ vọng: Vào dashboard User

3. Đăng nhập sai password
   - Username: admin
   - Password: sai
   ✓ Kỳ vọng: Hiển thị lỗi "Sai username hoặc password"
```

#### **Test Case 2: Quản lý người dùng (Admin Only)**
```
1. Vào mục "User Management" (Admin)
   ✓ Kỳ vọng: Xem danh sách: admin, user1, user2

2. Xem chi tiết user1
   ✓ Kỳ vọng: Hiển thị username, role, balance

3. Cấm người dùng (Ban User)
   - Chọn user2 → Ban
   ✓ Kỳ vọng: user2 bị chặn, status = BANNED

4. Bỏ cấm người dùng (Unban User)
   - Chọn user2 → Unban
   ✓ Kỳ vọng: user2 được phục hồi, status = ACTIVE

5. Cấp role cho người dùng
   - Chọn user2 → Add Role → MODERATOR
   ✓ Kỳ vọng: user2 có thêm role MODERATOR

6. Thu hồi role
   - Chọn user2 → Remove Role → MODERATOR
   ✓ Kỳ vọng: role MODERATOR bị xóa khỏi user2
```

#### **Test Case 3: Quản lý sản phẩm (Item Management)**
```
1. Xem danh sách sản phẩm (Admin hoặc User)
   ✓ Kỳ vọng: Hiển thị 3 sản phẩm: iPhone, Tranh, Xe

2. Tạo sản phẩm mới (Đăng nhập user1)
   - Chọn "Create Item"
   - Điền: Tên = "Laptop Dell"
   - Loại = Electronics
   - Giá = 15.000.000
   ✓ Kỳ vọng: Sản phẩm được thêm vào danh sách

3. Chỉnh sửa sản phẩm (user1)
   - Chọn sản phẩm "Laptop Dell"
   - Sửa giá thành 12.000.000
   ✓ Kỳ vọng: Giá được cập nhật

4. Xóa sản phẩm (user1)
   - Chọn sản phẩm "Laptop Dell"
   - Delete
   ✓ Kỳ vọng: Sản phẩm bị xóa khỏi danh sách
```

#### **Test Case 4: Hệ thống đấu giá (Auction - CHÍNH)**
```
1. Xem phiên đấu giá đang chạy (RUNNING)
   ✓ Kỳ vọng: Hiển thị "iPhone 15 Pro Max" - Bắt đầu 5 phút trước
                          - Kết thúc trong 2 giờ
                          - Giá hiện tại: 20.000.000
                          - Bước giá: 500.000

2. Theo dõi đấu giá (Watch)
   - Click "Watch" trên iPhone
   ✓ Kỳ vọng: Sản phẩm được thêm vào danh sách "Watching"

3. Tạo phiên đấu giá mới
   - Chọn "Create Auction"
   - Sản phẩm: "Tranh Sơn Dầu Hoa Sen"
   - Giá khởi điểm: 5.000.000
   - Bước giá: 100.000
   - Thời gian kết thúc: +1 tiếng
   ✓ Kỳ vọng: Phiên đấu giá được tạo, trạng thái SCHEDULED

4. Xem chi tiết phiên đấu giá
   - Click vào phiên iPhone
   ✓ Kỳ vọng: Hiển thị đầy đủ thông tin: sản phẩm, giá, thời gian, người bán
```

#### **Test Case 5: Đặt giá (Bidding - CHÍNH)**
```
1. Đăng nhập user2, vào phiên iPhone đang RUNNING

2. Đặt giá thành công
   - Giá đặt: 20.500.000 (≥ 20.000.000 + 500.000)
   ✓ Kỳ vọng: "Đặt giá thành công! Bạn là người đấu giá cao nhất"

3. Kiểm tra balance user2
   ✓ Kỳ vọng: Giảm 20.500.000 (reserve/hold balance)

4. User1 đặt giá cao hơn
   - Giá đặt: 21.000.000
   ✓ Kỳ vọng: "Đặt giá thành công! Bạn là người đấu giá cao nhất"

5. User2 nhận thông báo bị vượt
   ✓ Kỳ vọng: Nhận notification "Bạn đã bị đặt giá vượt"
   ✓ Kỳ vọng: Balance user2 được hoàn lại 20.500.000

6. Kiểm tra lịch sử đấu giá
   - User1 xem "Bid History" trên iPhone
   ✓ Kỳ vọng: Hiển thị 2 bid:
              - user2: 20.500.000
              - user1: 21.000.000 (highest)
```

#### **Test Case 6: Giao dịch & Thanh toán (Transaction)**
```
1. Khi phiên đấu giá kết thúc
   - Chờ 2 giờ hoặc admin kết thúc sớm
   ✓ Kỳ vọng: Trạng thái = FINISHED

2. Tạo giao dịch
   ✓ Kỳ vọng: Giao dịch được tạo:
              - Người thắng: user1
              - Giá thắng: 21.000.000
              - Trạng thái: PENDING

3. Thanh toán
   - user1 click "Confirm Payment"
   ✓ Kỳ vọng: Balance trừ 21.000.000
              Trạng thái transaction = COMPLETED

4. Xem lịch sử giao dịch
   - user1 xem "Transaction History"
   ✓ Kỳ vọng: Hiển thị giao dịch vừa hoàn tất
```

#### **Test Case 7: Ví (Wallet)**
```
1. Xem số dư (Balance)
   - user1: 10.000.000 (ban đầu)
   - Sau khi đấu giá + thanh toán: < 10.000.000
   ✓ Kỳ vọng: Số dư được cập nhật chính xác

2. Nạp tiền (Add Balance)
   - user1 click "Add Balance"
   - Nạp: 5.000.000
   ✓ Kỳ vọng: Balance tăng 5.000.000

3. Xem lịch sử giao dịch ví
   ✓ Kỳ vọng: Hiển thị tất cả lịch sử nạp tiền & trừ tiền
```

#### **Test Case 8: Audit Log (Admin Only)**
```
1. Vào mục "Audit Log" (Admin)
   ✓ Kỳ vọng: Hiển thị danh sách hoạt động hệ thống:
              - Login user1
              - Create Item
              - Create Auction
              - Place Bid
...
2. Xem chi tiết một hoạt động
   ✓ Kỳ vọng: Hiển thị: Người dùng, hành động, thời gian, chi tiết
```
