...
**UET Auction System** là một hệ thống đấu giá trực tuyến được xây dựng theo kiến trúc **Client-Server** sử dụng **Java Socket**. Hệ thống cho phép người dùng đăng ký, đấu giá các mặt hàng, theo dõi đấu giá, và quản lý giao dịch. Admin có quyền quản lý người dùng, mặt hàng, và đấu giá.
...
│   │   │   ├── server/              # Server: AuctionServer, ClientHandler, RequestProcessor
